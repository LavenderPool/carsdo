...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:17
...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:53
...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:99
* @route '/admin/cars/{car}/configurations'
*/
...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:112
...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:160
...
* @see app/Http/Controllers/Admin/CarConfigurationController.php:176
* @route '/admin/cars/{car}/configurations/{configuration}'
*/
