...
*/
export const edit = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}/edit'
*/
edit.url = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}/edit'
*/
edit.get = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}/edit'
*/
edit.head = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
...
*/
export const update = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
update.url = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
            configurationGroup: args[1],
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
update.put = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
update.patch = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
export const destroy = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
destroy.url = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
            configurationGroup: args[1],
...
* @route '/admin/cars/{car}/configuration-groups/{configurationGroup}'
*/
destroy.delete = (args: { car: number | { id: number }, configurationGroup: number | { id: number } } | [car: number | { id: number }, configurationGroup: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})

const CarConfigurationGroupController = { index, create, store, edit, update, destroy }

export default CarConfigurationGroupController