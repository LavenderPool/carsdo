...
*/
export const edit = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/admin/cars/{car}/equipment/{equipment}/edit'
*/
edit.url = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
            equipment: args[1],
...
* @route '/admin/cars/{car}/equipment/{equipment}/edit'
*/
edit.get = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: edit.url(args, options),
    method: 'get',
})
...
* @route '/admin/cars/{car}/equipment/{equipment}/edit'
*/
edit.head = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: edit.url(args, options),
    method: 'head',
})
...
*/
export const update = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
update.url = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
            equipment: args[1],
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
update.put = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: update.url(args, options),
    method: 'put',
})
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
update.patch = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
export const destroy = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
destroy.url = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            car: args[0],
            equipment: args[1],
...
* @route '/admin/cars/{car}/equipment/{equipment}'
*/
destroy.delete = (args: { car: string | number | { id: string | number }, equipment: string | number | { id: string | number } } | [car: string | number | { id: string | number }, equipment: string | number | { id: string | number } ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroy.url(args, options),
    method: 'delete',
})
