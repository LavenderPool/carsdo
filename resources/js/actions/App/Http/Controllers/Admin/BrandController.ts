...
* @see app/Http/Controllers/Admin/BrandController.php:20
* @route '/admin/brands'
*/
...
* @see app/Http/Controllers/Admin/BrandController.php:53
...
* @see app/Http/Controllers/Admin/BrandController.php:61
* @route '/admin/brands'
*/
