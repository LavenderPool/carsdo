...
class UpdateCarCatalogRequest extends FormRequest
{
    ...
    {
        /** @var CarCatalog $catalog */
        $catalog = $this->route('car_catalog');

        return [
            'name' => ['required', 'string', 'max:255'],
            'slug' => ['required', 'string', 'max:255', Rule::unique('car_catalogs', 'slug')->ignore($catalog->id)],
